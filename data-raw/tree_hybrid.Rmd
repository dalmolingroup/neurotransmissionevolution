...
pdf("tree_hybrid_raw.pdf", width = 5, height = 9)
  plot(
    temp_modified_phylo,
    type = "cladogram",
...
dev.off()
```
![Complete 476 eukaryotes tree. Green species have been filled in by a genus proxy in TimeTree. Red species have been filled in by looking at NCBI Taxonomy. Clade naming is described further in this document.](../data-raw/tree_hybrid.pdf){height=95%}
