...
if (!file.exists("data-raw/download/Eukaryota_species.nwk")) {
  download.file(
    ...
    "data-raw/download/Eukaryota_species.nwk"
  )
}
######################
######################
...
timetree_newick <- read.tree("data-raw/download/timetree_335_eukaryotes.nwk")
...
duplicated_genera <- scan("data-raw/duplicated_genera.txt", what = "character")
...
# loading newick tree obtained from timetree
tree_85k <- read.tree("data-raw/download/Eukaryota_species.nwk")
...
# para cada especie nao encontrada cujo genero estiver presente na arvore completa,
...
# para cada especie cujo genero nao está no timetree ou nao eh confiavel
