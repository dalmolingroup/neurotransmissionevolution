...
project, users can download the repository's latest release on github
(``\href{mailto:daniloimparato/neurotransmissionevolution@v1.0.0}{\nolinkurl{daniloimparato/neurotransmissionevolution@v1.0.0}}'')
...
function of its humans proteins in neurotransmission.
