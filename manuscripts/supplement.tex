...
thus making the task easier. \input{tree_ncbi.tex}
...
about the orthogroups related to our selected genes. \input{cogs.tex}
...
\hypertarget{root-info}{%
\subsection{Root info}\label{root-info}}
