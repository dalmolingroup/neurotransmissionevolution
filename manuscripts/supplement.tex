...
Abundances are the number of proteins in orthogroups of a species. These
abundances are aggregated and averaged according to the function of
their corresponding orthogroups. The orthogroup function is considered
to be the function of its human proteins. \input{analysis.abundance.tex}
