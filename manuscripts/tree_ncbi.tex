...
\caption{\label{tab:unnamed-chunk-2}Lists all organisms in STRING v11.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{rllll>{\raggedright\arraybackslash}p{20em}}
\toprule
\multicolumn{6}{c}{\cellcolor[HTML]{EEEEEE}{\textbf{Location: data-raw/download/species.v11.0.txt}}} \\
\multicolumn{6}{c}{\cellcolor[HTML]{EEEEEE}{\textbf{Source: stringdb-static.org/download/species.v11.0.txt}}} \\
...
\caption{\label{tab:unnamed-chunk-2}Links outdated taxon IDs to corresponding new ones.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{rllll>{\raggedright\arraybackslash}p{20em}}
\toprule
\multicolumn{6}{c}{\cellcolor[HTML]{EEEEEE}{\textbf{Location: data-raw/download/taxdump/merged.dmp}}} \\
\multicolumn{6}{c}{\cellcolor[HTML]{EEEEEE}{\textbf{Source: ftp.ncbi.nlm.nih.gov/pub/taxonomy/taxdump.tar.gz}}} \\
\cmidrule(l{3pt}r{3pt}){1-6}
\# & Col. name & Col. type & Used? & Example & Description\\
\midrule
...
\caption{\label{tab:unnamed-chunk-2}Represents taxonomy nodes.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{rllll>{\raggedright\arraybackslash}p{20em}}
\toprule
\multicolumn{6}{c}{\cellcolor[HTML]{EEEEEE}{\textbf{Location: data-raw/download/taxdump/nodes.dmp}}} \\
\multicolumn{6}{c}{\cellcolor[HTML]{EEEEEE}{\textbf{Source: ftp.ncbi.nlm.nih.gov/pub/taxonomy/taxdump.tar.gz}}} \\
\cmidrule(l{3pt}r{3pt}){1-6}
\# & Col. name & Col. type & Used? & Example & Description\\
\midrule
...
\caption{\label{tab:unnamed-chunk-2}Links taxon IDs to actual species names.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{rllll>{\raggedright\arraybackslash}p{20em}}
\toprule
\multicolumn{6}{c}{\cellcolor[HTML]{EEEEEE}{\textbf{Location: data-raw/download/taxdump/names.dmp}}} \\
\multicolumn{6}{c}{\cellcolor[HTML]{EEEEEE}{\textbf{Source: ftp.ncbi.nlm.nih.gov/pub/taxonomy/taxdump.tar.gz}}} \\
\cmidrule(l{3pt}r{3pt}){1-6}
\# & Col. name & Col. type & Used? & Example & Description\\
\midrule
...
\NormalTok{usethis}\OperatorTok{::}\KeywordTok{use_data}\NormalTok{(ncbi_tree, }\DataTypeTok{overwrite =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
