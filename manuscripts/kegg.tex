\hypertarget{neurotransmitter-pathways-annotation}{%
...
\CommentTok{# usethis::use_data(gene_pathways, overwrite = TRUE)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{updating-missing-info}{%
\paragraph{Updating missing info}\label{updating-missing-info}}
...
\CommentTok{# usethis::use_data(gene_ids, overwrite = TRUE)}
\end{Highlighting}
\end{Shaded}
