...
To explore and tweak this project, users can download the repository's latest release from github and run `devtools::install()`.  
...
Cnidarian ionotropic receptors expression
-----------
In this section, we look for the expression of ionotropic receptor orthologs in *Nematostella vectensis* neurons, made available as supplementary data in Sebé-Pedrós et al, 2018. 
