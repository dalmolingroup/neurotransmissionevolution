...
To explore and tweak this project, users can download the repository's latest release from github [(daniloimparato/neurotransmissionevolution)](https://github.com/daniloimparato/neurotransmissionevolution/releases) and run `devtools::install()`.  
...
Abundance
-----------
Abundances are the number of proteins in orthogroups of a species. These abundances are aggregated and averaged according to the function of their corresponding orthogroups. The orthogroup function is considered to be the function of its human proteins. 
