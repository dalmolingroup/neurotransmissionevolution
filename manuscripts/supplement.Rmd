...
To explore and tweak this project, users can download the repository's latest release from github [(dalmolingroup/neurotransmission-evolution)](https://github.com/dalmolingroup/neurotransmission-evolution/releases) and run `devtools::install()`.  
