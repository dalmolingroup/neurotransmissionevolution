...
header-includes:
  ...
  # - \newfontfamily{\emojifont}[Path=style/]{EmojiOneColor.otf}
  # - \newfontfamily{\emojifont}[Path=style/]{DejaVuSans.ttf}
...
└──📦 neurotransmissionevolution/
    ...
    ├──📄 DESCRIPTION
    ├──📄 NAMESPACE
    ├──📄 neurotransmissionevolution.Rproj
    └──📄 README.md
```
