...
\CommentTok{# Plotting and saving}
\KeywordTok{pdf.options}\NormalTok{(}\DataTypeTok{useDingbats =} \OtherTok{FALSE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pdf.options}\NormalTok{(}\DataTypeTok{useDingbats =} \OtherTok{TRUE}\NormalTok{)}
...
\begin{figure}
\subfloat[Set diagram for Figure 1A\label{fig:unnamed-chunk-121}]{\includegraphics{figs/analysis.network.unnamed-chunk-12-1} }\newline\subfloat[Set diagram for Figure 3A\label{fig:unnamed-chunk-122}]{\includegraphics{figs/analysis.network.unnamed-chunk-12-2} }\newline\subfloat[Set diagram for Figure 3B\label{fig:unnamed-chunk-123}]{\includegraphics{figs/analysis.network.unnamed-chunk-12-3} }\caption{Set diagrams}\label{fig:unnamed-chunk-12}
\end{figure}
