...
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{-45}\NormalTok{, }\DataTypeTok{vjust =} \DecValTok{0}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{0}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\subfloat[Set diagram for Figure 1A\label{fig:unnamed-chunk-171}]{\includegraphics{figs/analysis.network.unnamed-chunk-17-1} }\newline\subfloat[Set diagram for Figure 3A\label{fig:unnamed-chunk-172}]{\includegraphics{figs/analysis.network.unnamed-chunk-17-2} }\newline\subfloat[Set diagram for Figure 3B\label{fig:unnamed-chunk-173}]{\includegraphics{figs/analysis.network.unnamed-chunk-17-3} }\caption{Set diagrams}\label{fig:unnamed-chunk-17}
\end{figure}
