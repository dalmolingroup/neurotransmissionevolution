...
\NormalTok{roots_extant_clades         <-}\StringTok{ }\KeywordTok{read_tsv}\NormalTok{(}\StringTok{"geneplast_clade_names.tsv"}\NormalTok{,       }\DataTypeTok{col_types =} \StringTok{"ic"}\NormalTok{)}
...
\StringTok{  }\KeywordTok{inner_join}\NormalTok{(roots_extant_clades)}
...
{\centering \includegraphics{figs/analysis.network.unnamed-chunk-12-1} 

}

\caption{The human neurotransmission network with nodes rooted between roots 30 (Human-Choanoflagellata LCA) and 26 (Human-Cnidaria LCA).}\label{fig:unnamed-chunk-12}
\end{figure}
...
\begin{figure}
\subfloat[Set diagram for Figure 1A\label{fig:unnamed-chunk-131}]{\includegraphics{figs/analysis.network.unnamed-chunk-13-1} }\newline\subfloat[Set diagram for Figure 3A\label{fig:unnamed-chunk-132}]{\includegraphics{figs/analysis.network.unnamed-chunk-13-2} }\newline\subfloat[Set diagram for Figure 3B\label{fig:unnamed-chunk-133}]{\includegraphics{figs/analysis.network.unnamed-chunk-13-3} }\caption{Set diagrams}\label{fig:unnamed-chunk-13}
\end{figure}
