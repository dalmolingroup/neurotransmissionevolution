...
\NormalTok{gene_cogs <-}\StringTok{ }\NormalTok{cogs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(string_id }\OperatorTok{%in%}\StringTok{ }\NormalTok{gene_ids[[}\StringTok{"string_id"}\NormalTok{]]) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{taxid)}
...
\begin{verbatim}
## <U+2714> Saving 'gene_cogs' to 'data/gene_cogs.rda'
\end{verbatim}
