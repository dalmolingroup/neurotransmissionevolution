...
\StringTok{  }\KeywordTok{select}\NormalTok{(string_id, cog_id, entrez_name, }\DataTypeTok{pathway =}\NormalTok{ pathway_name, }\DataTypeTok{root =}\NormalTok{ Root)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## -Performing rooting analysis...
## --For 19 orthologous groups...
##   |                                                                              |                                                                      |   0%  |                                                                              |======================================================================| 100%
\end{verbatim}
