...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
     ...
     \DataTypeTok{max_abundance =} \KeywordTok{mean_se}\NormalTok{(abundance[lca }\OperatorTok{<=}\StringTok{ }\DecValTok{29}\NormalTok{], }\DecValTok{30}\NormalTok{)}\OperatorTok{$}\NormalTok{ymax}
