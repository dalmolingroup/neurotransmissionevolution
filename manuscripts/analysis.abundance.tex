...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Adding species and clade info to the abundance data frame}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Number of proteins in a function divided by number of all neural COGs in species"}\NormalTok{) }\OperatorTok{+}
...
\caption{Abundance values by species. Species are ordered like in Supplementary Figure S1.}\label{fig:unnamed-chunk-51}
\end{figure}
...
\KeywordTok{ggplot}\NormalTok{(abundance_by_function) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Number of proteins in a function divided by number of all neural proteins in species"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{metazoa_line }\OperatorTok{+}
...
\caption{Abundance values by species. Species are ordered like in Supplementary Figure S1.}\label{fig:unnamed-chunk-52}
\end{figure}
