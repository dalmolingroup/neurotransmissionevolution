...
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Average protein abundance in orthogroups"}\NormalTok{) }\OperatorTok{+}
...
\NormalTok{protein_count_by_cog <-}\StringTok{ }\NormalTok{cog_abundance_by_taxid }\OperatorTok{%>%}
