...
Plotting:
```{r fig.align="center", fig.height=8, fig.width=16, fig.cap="Abundance values by species. Species are ordered like in Supplementary Figure 1."}
...
```{r fig.align="center", fig.height=4.5, fig.width=6, fig.cap="Abundances averaged by clades."}
ggplot(avg_abundance_by_function) +
  ...
  facet_grid(annotation ~ ., scales = "free", space = "free_y") +
  theme(
