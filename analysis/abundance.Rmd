...
# Adding species and clade info to the abundance data frame
...
ggplot(abundance_by_function) +
  ggtitle("Number of proteins in a function divided by number of all neural COGs in species") +
  metazoa_line +
...
# Proportion --------------------
ggplot(abundance_by_function) +
  ggtitle("Number of proteins in a function divided by number of all neural proteins in species") +
  metazoa_line +
