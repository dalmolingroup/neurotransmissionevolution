...
```{r rows.print=5}
# carregando newick
phyloTree <- read.tree("../inst/extdata/hybrid_tree_modified.nwk")
...
write_tsv(roots, "geneplast_roots_modified.tsv")
```
...
write_tsv(roots_names, "geneplast_clade_names_modified.tsv")
```
